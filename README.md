...
[![Build Status](https://travis-ci.org/willkoua/willkoua/uziya_api.svg?branch=develop)](https://travis-ci.org/willkoua/willkoua/uziya_api)
...
api uziya
 ...
 - Documentation: https://uziya-api.readthedocs.io.
...
```
git clone https://github.com/willkoua/uziya-api.git
```
